          ...
          <div className="activitiesSection3RowItemRight">
            ...
            <article className="wahtText">
              <p>
                ...
                самостоятельно оформят свидетельство о смерти и обеспечат
                первичную опеку над умершим до тех пор, пока ближайшие
                родственники не выберут похоронное бюро, которое займется телом.
              </p>
              <p>
