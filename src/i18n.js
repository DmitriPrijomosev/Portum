...
const resources = {
  ee: {
    translation: {
      ...
      "section10.6": "E - R 9.00-17.00",
      "section10.7": "Laupäev 9.30-16.00",
    },
  },
  ru: {
    translation: {
      ...
      "section10.7": "Суббота 9.30-16.00",
    },
  },
};
...
i18n
  ...
  .init({
    resources,
    lng: localStorage.getItem("Portum_lang") || "ee", // language to use, more information here: https://www.i18next.com/overview/configuration-options#languages-namespaces-resources
